...
shared_ptr<OpenABEKey> OpenABEKeystore::getKey(const string keyID) {
 ...
 */
bool OpenABEKeystore::checkSecretKey(const string keyID) {
...
shared_ptr<OpenABEKey> OpenABEKeystore::getPublicKey(const string keyID) {
...
shared_ptr<OpenABEKey> OpenABEKeystore::getSecretKey(const string keyID) {
  shared_ptr<OpenABEKey> result;
 ...
 * @return              - An error code (OpenABE_ERROR_INVALID_KEY) or
 * OpenABE_NOERROR
 */

OpenABE_ERROR OpenABEKeystore::deleteKey(const string keyID) {
...
OpenABEKeystore::constructKeyFromBytes(const string &keyID,
  ...
  try {
    if (keyBlob.size() < hdrLen) {
      THROW_ERROR(OpenABE_ERROR_INVALID_LENGTH);
    }
