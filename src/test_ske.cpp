...
TEST_F(KDFNistTestVector, DK1Test) {
  ...
  /* test 1 */
  uint8_t dk1[] = {0x12, 0x0f, 0xb6, 0xcf, 0xfc, 0xf8, 0xb3, 0x2c, 0x43, 0xe7, 0x22,
                   0x52, 0x56, 0xc4, 0xf8, 0x37, 0xa8, 0x65, 0x48, 0xc9, 0x2c, 0xcc,
                   0x35, 0x48, 0x08, 0x05, 0x98, 0x7c, 0xb7, 0x0b, 0xe1, 0x7b}; // (32 octets)
  P = "password";
  S = "salt";
  c = 1;
  dkLen = 32;
...
TEST_F(KDFNistTestVector, DK2Test) {
  ...
  /* test 2 */
  uint8_t dk2[] = {0xae, 0x4d, 0x0c, 0x95, 0xaf, 0x6b, 0x46, 0xd3, 0x2d, 0x0a,
                   0xdf, 0xf9, 0x28, 0xf0, 0x6d, 0xd0, 0x2a, 0x30, 0x3f, 0x8e}; // (20 octets)
...
TEST_F(KDFNistTestVector, DK3Test) {
  ...
  uint8_t dk3[] = {0xcf, 0x81, 0xc6, 0x6f, 0xe8, 0xcf, 0xc0, 0x4d, 0x1f, 0x31,
...
TEST_F(KDFNistTestVector, DK4Test) {
  ...
  uint8_t dk4[] = {
      ...
      0x6e, 0x84, 0xcf, 0x2b, 0x17, 0x34, 0x7e, 0xbc, 0x18, 0x00, 0x18, 0x1c}; // (25 octets)
...
TEST(KDF, CheckPassWithNonHexHashString) {
  ...
  ASSERT_THROW(checkPassword("foosdfasdfasdfasdfasdfasdfasdfadfafoosdfasdfasdfasdfasdfzxyfasdf",
                             "password1"),
               OpenABE_ERROR);
}
