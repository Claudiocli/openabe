...
typedef enum _zKeyType { KEY_TYPE_PUBLIC, KEY_TYPE_SECRET } zKeyType;
...
public:
  ...
  OpenABE_ERROR addKey(const std::string name, const std::shared_ptr<OpenABEKey>& component,
                       zKeyType keyType);
  ...
  std::shared_ptr<OpenABEKey> parseKeyHeader(const std::string keyID, OpenABEByteString& keyBlob,
