...
protected:
  ...
  inline ZP calculateCoefficient(OpenABETreeNode* treeNode, uint32_t index, uint32_t threshold,
                                 uint32_t total);
...
std::pair<bool, int> checkIfSatisfied(OpenABEPolicy* policy, OpenABEAttributeList* attr_list,
                                      bool reset_flags = true);
