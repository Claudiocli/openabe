...
public:
  ...
  std::pair<std::string, oabe::OpenABEByteString> getKeyCommand(const std::string& userId,
  ...
  const std::string storeWithKeyPrefixCommand(const std::string& userId,
  ...
  void setPassphrase(const std::string& programId, const std::string& userId,
