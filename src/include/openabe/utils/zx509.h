...
public:
  ...
  static void
  makeDistinguishedName(DistinguishedName& dn,
...
public:
   ...
   */
  static void fromKeyString(KeyCertifier& certifier, const std::string& privateKey);
   ...
   *                      expire
   */
  void generateCertificate(std::string& cert, const std::string& publicKey,
                           const std::string& commonName, int daysValid = 1461);
   ...
   */
  void generateCertificate(std::string& cert, const std::string& publicKey,
                           const DistinguishedName& issuerDn, const DistinguishedName& subjectDn,
                           int daysValid = 1461);
...
protected:
  ...
  static bool addDnToX509Name(const DistinguishedName& dn, X509_NAME* name);
};
 ...
 *                      expire
 */
void certifyKeyAsCA(std::string& cert, const std::string& privateKey, int daysValid = 1461);
