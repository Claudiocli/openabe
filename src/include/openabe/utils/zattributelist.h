...
protected:
  ...
  void setAttributes(std::vector<std::string>& attr_list, std::vector<std::string>& orig_attr_list,
...
public:
  ...
  bool hasOrigAttributes() const {
    return (this->m_OriginalAttributes.size() > 0);
  }
  ...
  const std::vector<std::string>* getAttributeList() const {
    return &this->m_Attributes;
  }
  const std::vector<std::string>* getOriginalAttributeList() const {
    return &this->m_OriginalAttributes;
  }
  OpenABEAttributeList* clone() const {
    return new OpenABEAttributeList(*this);
  }
