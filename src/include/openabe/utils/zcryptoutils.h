...
bool OpenABEUtilsHashToString(
    GT& input, uint32_t keyLen, OpenABEByteString& result,
...
OpenABE_ERROR decryptUnderPassword(const std::string password, OpenABEByteString& inputCTBlob,
