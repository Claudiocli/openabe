...
public:
  ...
  /* helper functions */
  std::unique_ptr<OpenABEPolicy> getPolicy() {
    return std::move(this->final_policy);
  }
  std::unique_ptr<OpenABEAttributeList> getAttributeList() {
  ...
  std::vector<std::string>* concat_attr(std::vector<std::string>* attr1,
                                        std::vector<std::string>* attr2);
  std::vector<std::string>* attr_num(const std::string& c, OpenABEUInteger* number);
  std::vector<std::string>* set_date_in_attrlist(const std::string& prefix,
                                                 const std::string& month, OpenABEUInteger* m,
  ...
  OpenABETreeNode* range_policy(const std::string& c, OpenABEUInteger* min_num,
                                OpenABEUInteger* max_num);
  OpenABETreeNode* range_incl_policy(const std::string& c, OpenABEUInteger* min_num,
                                     OpenABEUInteger* max_num);
  OpenABETreeNode* set_date_in_policy(const std::string& prefix, OpenABEUInteger* m,
                                      OpenABEUInteger* d, OpenABEUInteger* y);
  OpenABETreeNode* gt_date_in_policy(const std::string& prefix, OpenABEUInteger* m,
                                     OpenABEUInteger* d, OpenABEUInteger* y);
  OpenABETreeNode* ge_date_in_policy(const std::string& prefix, OpenABEUInteger* m,
                                     OpenABEUInteger* d, OpenABEUInteger* y);
  OpenABETreeNode* lt_date_in_policy(const std::string& prefix, OpenABEUInteger* m,
                                     OpenABEUInteger* d, OpenABEUInteger* y);
  OpenABETreeNode* le_date_in_policy(const std::string& prefix, OpenABEUInteger* m,
                                     OpenABEUInteger* d, OpenABEUInteger* y);
  OpenABETreeNode* range_date_in_policy(const std::string& prefix, OpenABEUInteger* m,
...
inline std::string MakeUniqueLabel(const std::string base, const std::string keyword,
                                   std::string unique) {
