...
public:
  ...
  void setSchemeType(OpenABE_SCHEME scheme_type) {
    this->algID = scheme_type;
  }
  OpenABE_SCHEME getSchemeType() {
    return this->algID;
  }
  //  virtual OpenABE_ERROR generateParams(OpenABESecurityLevel securityLevel,
  //                                   const std::string &mpkID, const std::string &mskID) = 0;
  virtual OpenABE_ERROR generateParams(const std::string groupParams, const std::string& mpkID,
                                       const std::string& mskID) = 0;
  virtual OpenABE_ERROR generateDecryptionKey(OpenABEFunctionInput* keyInput,
                                              const std::string& keyID, const std::string& mpkID,
                                              const std::string& mskID,
                                              const std::string& gpkID = "",
                                              const std::string& GID = "") = 0;
  virtual OpenABE_ERROR encryptKEM(OpenABERNG* rng, const std::string& mpkID,
  ...
  virtual OpenABE_ERROR decryptKEM(const std::string& mpkID, const std::string& keyID,
...
public:
  ...
  OpenABE_SCHEME getSchemeType() {
    return this->m_KEM_->getSchemeType();
  }
  ...
  OpenABE_ERROR generateParams(OpenABESecurityLevel securityLevel, const std::string& mpkID,
                               const std::string& mskID);
  OpenABE_ERROR generateParams(const std::string groupParams, const std::string& mpkID,
                               const std::string& mskID);
  ...
  OpenABE_ERROR keygen(OpenABEFunctionInput* keyInput, const std::string& keyID,
                       const std::string& mpkID, const std::string& mskID,
                       const std::string& gpkID = "", const std::string& GID = "");
  OpenABE_ERROR encrypt(OpenABERNG* rng, const std::string& mpkID,
                        const OpenABEFunctionInput* encryptInput, OpenABEByteString* plaintext,
