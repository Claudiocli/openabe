...
protected:
  ...
  bool validateParams(const std::string& paramsID) {
    return true;
  };
...
public:
  ...
  OpenABE_ERROR sign(OpenABEPKey* privKey, OpenABEByteString* message,
                     OpenABEByteString* signature);
  OpenABE_ERROR verify(OpenABEPKey* pubKey, OpenABEByteString* message,
                       OpenABEByteString* signature);
};
...
public:
  ...
  OpenABE_ERROR generateParams(const std::string groupParams);
  OpenABE_ERROR keygen(const std::string& pkID, const std::string& skID);
  OpenABE_ERROR sign(const std::string& skID, OpenABEByteString* message,
                     OpenABEByteString* signature);
  OpenABE_ERROR verify(const std::string& pkID, OpenABEByteString* message,
                       OpenABEByteString* signature);
};
