...
void LogTestResult(string testName, bool (*testPtr)(), const string fname) {
...
bool Test_InitializeLibrary() {
  InitializeOpenABE();
  return true;
}

bool Test_ShutdownLibrary() {
  ShutdownOpenABE();
  return true;
}

bool Test_BP_EC_Group() {
