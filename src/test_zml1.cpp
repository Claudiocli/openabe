...
void LogTestResult(string testName, bool (*testPtr)(const string& arg), const string fname,
                   const string curve_param = "") {
...
bool Test_InitializeLibrary(const string& arg) {
  InitializeOpenABE();
  return true;
}

bool Test_ShutdownLibrary(const string& arg) {
  ShutdownOpenABE();
  return true;
}

bool Test_ZP_operations(const string& curve_id) {
...
bool Test_G1_operations(const string& curve_id) {
  Benchmark benchOps;
  OpenABE_ERROR result = OpenABE_NOERROR;
  OpenABEPairing pgroup(DEFAULT_BP_PARAM);
  //    OpenABERNG rng;
...
bool Test_G2_operations(const string& curve_id) {
  Benchmark benchOps;
  OpenABE_ERROR result = OpenABE_NOERROR;
  OpenABEPairing pgroup(DEFAULT_BP_PARAM);
  //    OpenABERNG rng;
...
bool Test_GT_operations(const string& curve_id) {
  Benchmark benchOps;
  OpenABE_ERROR result = OpenABE_NOERROR;
  OpenABEPairing pgroup(DEFAULT_BP_PARAM);
  //    OpenABERNG rng;
...
bool Test_BP_operations(const string& curve_id) {
  Benchmark benchOps;
  OpenABE_ERROR result = OpenABE_NOERROR;
  OpenABEPairing pgroup(DEFAULT_BP_PARAM);
  ...
  try {
    ...
    cout << "bp is correct: e(g1^a, g2^b) == e(g1, g2)^(ab) => " << (gta == gtb ? "true" : "false")
         << endl;
...
int Test_RunAllTests(const string& curve_id) {
  ...
  //    LogTestResult("G1 operations are correct", Test_G1_operations, "Test_G1_operations",
  //    curve_id); LogTestResult("G2 operations are correct", Test_G2_operations,
  //    "Test_G2_operations", curve_id); LogTestResult("GT operations are correct",
  //    Test_GT_operations, "Test_GT_operations", curve_id); LogTestResult("Pairing operations are
  //    correct", Test_BP_operations, "Test_BP_operations", curve_id);
